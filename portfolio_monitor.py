...
3. 코멘트 작성 규칙 (엄수):
   - 뉴스 원문에 명시된 사실만 기술
   - 계열사/자회사 관계는 절대 직접 판단 금지. 같은 브랜드명이라도 계열사로 단정하지 말 것
   - 특히 아래 기업은 롯데그룹/롯데지주 계열사가 아님 (매각 완료):
     * 롯데카드 → MBK파트너스 매각 완료 (롯데지주 계열사 아님)
     * 롯데손해보험(롯데손보) → MBK파트너스 매각 완료 (롯데지주 계열사 아님)
     * 롯데렌탈 → 매각 실패, 여전히 롯데지주 계열사임
   - "롯데" 이름이 들어간 기업이라도 현재 롯데지주 산하인지 뉴스 원문에서 확인된 경우에만 언급
